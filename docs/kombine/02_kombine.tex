...
\begin{figure}[ht]
  ...
  \caption{\label{fig:lung-dataset-cells} \KM{} curves for the regression-free survival of patients with lung cancer who were treated with neoadjuvant anti-PD-1 immunotherapy, stratifying patients by their pre-treatment densities of CD8+FoxP3+ cells. Panel A shows the full uncertainty, while panels B and C show the uncertainties broken down into patient-wise and binomial contributions, respectively.}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{lung_donuts_km_RFS.pdf}
  \caption{\label{fig:lung-dataset-donuts} \KM{} curves for the regression-free survival of patients with lung cancer who were treated with neoadjuvant anti-PD-1 immunotherapy, stratifying patients by their pre-treatment densities of DONUTS\@. Panel A shows the full uncertainty, while panels B and C show the uncertainties broken down into patient-wise and binomial contributions, respectively.}
\end{figure}
...
Figure~\ref{fig:lung-dataset-cells}A shows \KM{} curves for regression-free survival (RFS) of patients with high and low densities of CD8+FoxP3+ cells. The patients with a high density of CD8+FoxP3+ cells have better outcomes, as expected, but the error bands are large due to the high Poisson uncertainty in the number of CD8+FoxP3+ cells. By contrast, Fig.~\ref{fig:lung-dataset-donuts}A shows the \KM{} curves for RFS of patients with high and low densities of DONUTS\@. The error bands are smaller, as the DONUTS are much more abundant.

Figures~\ref{fig:lung-dataset-cells}B and \ref{fig:lung-dataset-donuts}B show the same \KM{} curves with the patient-wise uncertainties, while Figs.~\ref{fig:lung-dataset-cells}C and \ref{fig:lung-dataset-donuts}C show the binomial uncertainties. The binomial uncertainties have similar magnitude for the cells and for the DONUTS, as both have similar sample sizes in the high and low categories. The patient-wise uncertainties, on the other hand, are comparable to the binomial errors for the cells but almost zero for the DONUTS\@.
