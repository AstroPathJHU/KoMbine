...
\begin{align}
\begin{aligned}
-\log \mathcal{L}_{\text{binomial},1,2} =&-\left[\vphantom{\log p_{1,2}^\text{s}}\log\binom{r_1}{d_1+d_2} + (d_1+d_2) \log \left(1-p_{1,2}^\text{s}\right)\right. \\
&\left.\vphantom{\log p_{1,2}^\text{s}}\quad + (r_1-d_1-d_2) \log p_{1,2}^\text{s}\right] \\
