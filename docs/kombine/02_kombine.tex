...
In Fig.~\ref{fig:compare-to-greenwood-small-n}, only 12 patients are included in the \KM{} curve, and the exponential Greenwood confidence intervals are noticeably different from the \KoMbine{} intervals. Figure~\ref{fig:compare-to-greenwood-large-n} shows \KM{} curves with 100 patients, and the two confidence intervals are in agreement.
...
\begin{figure}[ht]
  ...
  \begin{minipage}[c]{\legendwidth}
    \centering
    \movelegendup
    \includegraphics[width=\linewidth]{lung_cells_km_RFS_legend.pdf}
  \end{minipage}
  \begin{subfigure}[c]{\figwidth}
    \centering
  ...
  \begin{minipage}[c]{\legendwidth}
    \centering
    \movelegendup
    \includegraphics[width=\linewidth]{lung_donuts_km_RFS_legend.pdf}
  \end{minipage}
