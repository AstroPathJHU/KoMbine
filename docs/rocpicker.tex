...
In this simple example, we have 3 responders and 3 non-responders (in reality, there don't have to be the same number of patients in both categories).  The responders have \(t_r=(-2, -2, 1)\), while the non-responders have \(t_n=(-1, 2, 2)\).  The ROC curve is shown in \cref{fig:exampledata_discrete} (left).  The middle plot shows a likelihood scan for the AUC.  The right hand plot shows the ROC curves corresponding to the 68\% and 95\% AUCs.
