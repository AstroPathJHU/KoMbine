...
rocpicker_delta_functions ../test/datacards/simple_examples/datacard_example_1.txt --scan-filename delta_functions_scan_compare_to_discrete.pdf --y-upper-limit 20 --npoints 100
