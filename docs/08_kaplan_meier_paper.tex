...
This procedure can be applied recursively to collapse any number of consecutive time points with no censoring in between.  \pkg{KoMbine} automatically collapses such time points before performing the NLL minimization.
