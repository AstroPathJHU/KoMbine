...
\end{subfigure}
\caption{\label{fig:compare-to-greenwood} \KM{} curves with confidence intervals, using only the binomial error, calculated using the exponential Greenwood formula from \cref{eq:exponential-greenwood} (gold) and the likelihood method from \pkg{KoMbine} (blue).}
\end{figure}
